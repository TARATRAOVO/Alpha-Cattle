cpiPanel <- tabPanel(
      ...
      div(
        ...
        tags$div(
          ...
          tags$ol(
            class = "tutorial",
            tags$li(
              "Phenotype file in type 1(for CPI1/CPI3 calculation):",
              tags$ul(
            ...
            div(class = "inlay", style = "height:20px;width:100%;background-color: white;"),
            tags$li(
              "Phenotype file in type 2(for CPI2 calculation):",
              tags$ul(
                tags$li("Phenotype file can be comma or white space separated"),
                tags$li("Phenotype file MUST have column names (header)"),
                tags$li("The first column of Phenotype file MUST be animal ID"),
  ...
  fluidRow(
    ...
    column(
      ...
      id = "model_box",
      mod_comp_box1(
        id = "cpi_trt1", label = "Traits to be calculated :", title = "Traits",
      ...
      mod_comp_box1(
        id = "cpi_fct1", label = "Fixed effect (factor) :", title = "Fixed effects",
        content = "You can specify multiple fixed factors"
      ),
      mod_comp_box1(
        id = "cpi_cov1", label = "Fixed effect (covariate) :", title = "Covariate",
        content = "You can specify multiple covariate varibles which are also considered fixed effects"
      ),
      mod_comp_box1(
        id = "cpi_gen1", label = "Random effect (genetic) :", title = "Genetic random effects",
      ...
      mod_comp_box1(
        id = "cpi_rnd1", label = "Random effect (other) :", title = "Non-genetic random effects",
  ...
  fluidRow(
    ...
    column(
      ...
      id = "model_box",
      mod_comp_box2(
        id = "cpi_trt2", label = "Traits to be calculated :", title = "Traits",
        content = "You MUST choose traits the SAME as the traits in your trait file. No more and No less, which means you should choose Milk, Fatpct, Propct, SCS, Type, MS and FL and upload them in your Phenotype file!"
      ),
      mod_comp_box2(
        id = "cpi_fct2", label = "Fixed effect (factor) :", title = "Fixed effects",
        content = "You can specify multiple fixed factors"
      ),
      mod_comp_box2(
        id = "cpi_cov2", label = "Fixed effect (covariate) :", title = "Covariate",
        content = "You can specify multiple covariate varibles which are also considered fixed effects"
      ),
      mod_comp_box2(
        id = "cpi_gen2", label = "Random effect (genetic) :", title = "Genetic random effects",
        content = "This is for the  random effect that the pedigree-based or genotype-based or their combined relationship matrix is exerted on. Please note that Alpha-Cattle now only support unique random genetic effect. You may supply more varibles but only the first one is considered"
      ),
      mod_comp_box2(
        id = "cpi_rnd2", label = "Random effect (other) :", title = "Non-genetic random effects",
        content = "This is for the non-genetic random effect, such as permenent environmental effect, dam effect, etc.",
        placement = "left"
      )
    )
