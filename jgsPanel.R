jgsPanel <- tabPanel(
      ...
      div(
        ...
        tags$div(
          ...
          tags$ol(
            class = "tutorial",
            tags$li(
              "We will use different computational models for different phenotypic types:",
              tags$ul(
            ...
            tags$li(
              "Upload files and different combination of files means different methods using combined population:",
              tags$ul(
  ...
  fluidRow(
    ...
    column(
      ...
      id = "model_box",
      mod_comp_box(
        id = "jgs_trt", label = "Traits to be calculated :", title = "Traits", content =
          "You can specify multiple traits, which will be analyzed one by one"
      ),
      mod_comp_box(
        id = "jgs_fct", label = "Fixed effect (factor) :", title = "Fixed effects",
        content = "You can specify multiple fixed factors"
      ),
      mod_comp_box(
        id = "jgs_cov", label = "Fixed effect (covariate) :", title = "Covariate",
        content = "You can specify multiple covariate varibles which are also considered fixed effects"
      ),
      mod_comp_box(
        id = "jgs_gen", label = "Random effect (genetic) :", title = "Genetic random effects",
      ...
      mod_comp_box(
        id = "jgs_rnd", label = "Random effect (other) :", title = "Non-genetic random effects",
