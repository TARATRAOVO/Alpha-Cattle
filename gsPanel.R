gsPanel <- tabPanel(
      ...
      div(
        ...
        tags$div(
          ...
          tags$ol(
            ...
            tags$li(
              "Upload files and different combination of files means different methods:",
              tags$ul(
  ...
  fluidRow(
    ...
    column(
      ...
      id = "model_box",
      mod_comp_box(
        id = "gs_trt", label = "Traits to be calculated :", title = "Traits",
        content = "You can specify multiple traits, which will be analyzed one by one"
      ),
      mod_comp_box(
        id = "gs_fct", label = "Fixed effect (factor) :", title = "Fixed effects",
        content = "You can specify multiple fixed factors"
      ),
      mod_comp_box(
        id = "gs_cov", label = "Fixed effect (covariate) :", title = "Covariate",
        content = "You can specify multiple covariate varibles which are also considered fixed effects"
      ),
      mod_comp_box(
        id = "gs_gen", label = "Random effect (genetic) :", title = "Genetic random effects",
      ...
      mod_comp_box(
        id = "gs_rnd", label = "Random effect (other) :", title = "Non-genetic random effects",
