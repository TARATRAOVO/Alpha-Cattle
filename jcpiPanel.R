jcpiPanel <- tabPanel(
  ...
  fluidRow(
    ...
    column(
      ...
      id = "model_box",
      mod_comp_box1(
        id = "jcpi_trt1", label = "Traits to be calculated :", title = "Traits",
      ...
      mod_comp_box1(
        id = "jcpi_fct1", label = "Fixed effect (factor) :", title = "Fixed effects",
        content = "You can specify multiple fixed factors"
      ),
      mod_comp_box1(
        id = "jcpi_cov1", label = "Fixed effect (covariate) :", title = "Covariate",
        content = "You can specify multiple covariate varibles which are also considered fixed effects"
      ),
      mod_comp_box1(
        id = "jcpi_gen1", label = "Random effect (genetic) :", title = "Genetic random effects",
      ...
      mod_comp_box1(
        id = "jcpi_rnd1", label = "Random effect (other) :", title = "Non-genetic random effects",
  ...
  fluidRow(
    ...
    column(
      ...
      id = "model_box",
      mod_comp_box2(
        id = "jcpi_trt2", label = "Traits to be calculated :", title = "Traits",
        content = "You MUST choose traits the SAME as the traits in your trait file. No more and No less, which means you should choose Milk, Fatpct, Pr opct, SCS, Type, MS and FL and upload them in your Phenotype file!"
      ),
      mod_comp_box2(
        id = "jcpi_fct2", label = "Fixed effect (factor) :", title = "Fixed effects",
        content = "You can specify multiple fixed factors"
      ),
      mod_comp_box2(
        id = "jcpi_cov2", label = "Fixed effect (covariate) :", title = "Covariate",
        content = "You can specify multiple covariate varibles which are also considered fixed effects"
      ),
      mod_comp_box2(
        id = "jcpi_gen2", label = "Random effect (genetic) :", title = "Genetic random effects",
        content = "This is for the  random effect that the pedigree-based or genotype-based or their combined relationship matrix is exerted on. Please note that Alpha-Cattle now only support unique random genetic effect. You may supply more varibles but only the first one is considered"
      ),
      mod_comp_box2(
        id = "jcpi_rnd2", label = "Random effect (other) :", title = "Non-genetic random effects",
        content = "This is for the non-genetic random effect, such as permenent environmental effect, dam effect, etc.",
        placement = "left"
      )
    )
